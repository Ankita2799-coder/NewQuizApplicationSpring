...
import com.harbourxquizapp.model.ResultData;
...
import com.harbourxquizapp.repository.ResultRepo;
...
public class UserController {
	...
	public ResponseEntity<?> UpdateText(@RequestBody homeText homeEditvo)
	{
		...
		return ResponseEntity.ok("successfully changed name");
	}
	@PostMapping("/result")
	public ResponseEntity<?> saveResultDetails(@RequestBody ResultData resultData)
	{
		resultRepo.save(resultData);
		return ResponseEntity.ok("successfully saved");
	}
	@GetMapping("/homeText/{homeId}")
